    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, null=True, upload_to='user_avatar/%Y-%m-%d/', verbose_name='Аватарка')),
                ('address', models.CharField(blank=True, max_length=200, null=True, verbose_name='Адрес проживания')),
                ('phone_num', models.PositiveSmallIntegerField(verbose_name='Номер телефона')),
