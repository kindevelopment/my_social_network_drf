...
SECRET_KEY = 'django-insecure-ad7g)lnp$ng6z*-v0@9i9_7kiztdt(^ki(wj051t&n%#^@#qdl'
...
SIMPLE_JWT = {
    ...
    "ALGORITHM": "HS256",  #Алгоритмы шифрования
    "SIGNING_KEY": SECRET_KEY,   # Секретный ключ для шифрования
    "VERIFYING_KEY": "",
    "AUDIENCE": None,
    "ISSUER": None,
    "JSON_ENCODER": None,
